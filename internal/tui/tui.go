...
import (
	...
	"github.com/mohammadtihame/maebrcode/internal/permission"
	"github.com/mohammadtihame/maebrcode/internal/pubsub"
	"github.com/mohammadtihame/maebrcode/internal/session"
	"github.com/mohammadtihame/maebrcode/internal/tui/components/chat"
	"github.com/mohammadtihame/maebrcode/internal/tui/components/core"
	"github.com/mohammadtihame/maebrcode/internal/tui/components/dialog"
	"github.com/mohammadtihame/maebrcode/internal/tui/layout"
	"github.com/mohammadtihame/maebrcode/internal/tui/page"
	"github.com/mohammadtihame/maebrcode/internal/tui/theme"
	"github.com/mohammadtihame/maebrcode/internal/tui/util"
)
...
func New(app *app.App) tea.Model {
	...
	model.RegisterCommand(dialog.Command{
		...
		Description: "Create/Update the MaebrCode.md memory file",
		Handler: func(cmd dialog.Command) tea.Cmd {
			prompt := `Please analyze this codebase and create a MaebrCode.md file containing:
1. Build/lint/test commands - especially for running a single test
2. Code style guidelines including imports, formatting, types, naming conventions, error handling, etc.

The file you create will be given to agentic coding agents (such as yourself) that operate in this repository. Make it about 20 lines long.
If there's already a maebrcode.md, improve it.
